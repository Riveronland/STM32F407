...
xTaskCreate( ethernetif_input,
                "EthIf", /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
...
static err_t low_level_output(struct netif *netif, struct pbuf *p)
{
  ...
  // HAL_ETH_Transmit(&heth, &TxConfig,3000);
  HAL_ETH_Transmit_IT(&heth, &TxConfig);
  // xSemaphoreTake(TxPktSemaphore, TIME_WAITING_FOR_INPUT);
